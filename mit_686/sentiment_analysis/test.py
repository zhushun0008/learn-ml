...
if __name__ == "__main__":
    main()
    a = np.array([0.73559565, 0.64157371, 0.13731378, 0.70766729, 0.20734845, 0.94382844, 0.86728457, 0.40622058, 0.33401647, 0.18068472])
    b = np.array([0.06797213, 0.07793337, 0.36412953, 0.07065467, 0.24113998, 0.05297573, 0.0576512, 0.12308584, 0.14969322, 0.27672512])
    theta_0 = 0.5
    label = -1
